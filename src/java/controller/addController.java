...
public class addController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        HttpSession listSession = request.getSession();
        listSession.setAttribute("listAddress", ad.getListAddress());
    ...
    throws ServletException, IOException {
        ...
        Person person = new Person(name, age, phone, addressDAO.getAddress(address));
