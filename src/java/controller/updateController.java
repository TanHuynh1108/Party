...
public class updateController extends HttpServlet {
    ...
    throws ServletException, IOException {
       ...
       request.setAttribute("person", pd.getPerson(id));
       AddressDAO ad = new AddressDAO();
       request.setAttribute("listAddress", ad.getListAddress());
    ...
    throws ServletException, IOException {
        ...
        AddressDAO ad = new AddressDAO();
        Person p = new Person(id, name, age, phone, ad.getAddress(addressID));
        PersonDAO pd = new PersonDAO();
        pd.updatePerson(p);
